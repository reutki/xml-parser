...
async function main() {
	...
	function regexGenerator(file) {
		...
		let endIndex = inputTemplate.substring(startIndex, file.length);
		let index = 0;
	...
	const lines = getStrById();
	const initialTabStrings = getOriginalStrings();
	const totalIndecies = getIndeciesOfOriginalStrings();
	...
	var processingArr = generateFinalLines();
